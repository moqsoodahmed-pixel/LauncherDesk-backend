    ...
    <div style="font-family:sans-serif;max-width:620px;margin:0 auto;color:#1a2b3c">
      ...
      <div style="background:#fff;padding:28px;border:1px solid #e2e8f0;border-top:none;border-radius:0 0 12px 12px">
        <table style="width:100%;border-collapse:collapse;margin-bottom:20px">
          ...
          <tr><td style="padding:10px 12px;font-weight:700;width:160px;border:1px solid #e2e8f0;font-size:13px">Full Name</td><td style="padding:10px 12px;border:1px solid #e2e8f0;font-size:13px">${data.firstName} ${data.lastName}</td></tr>
          ...
          ${data.resumeUrl ? `<tr style="background:#F8FAFF"><td style="padding:10px 12px;font-weight:700;border:1px solid #e2e8f0;font-size:13px">Resume</td><td style="padding:10px 12px;border:1px solid #e2e8f0;font-size:13px"><a href="https://launcherdesk-backend-production.up.railway.app${data.resumeUrl}" style="color:#1D6FE0;font-weight:600">Download Resume →</a></td></tr>` : ''}
        </table>
        <p style="font-size:12px;color:#94A3B8;text-align:center;margin-top:20px">Submitted via LauncherDesk Careers Page · <a href="https://launcherdesk.in/company/careers" style="color:#1D6FE0">launcherdesk.in/company/careers</a></p>
      </div>
    </div>
  `,
})
  ...
  html: `
    <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#1a2b3c">
      ...
      <div style="background:#fff;padding:28px;border:1px solid #e2e8f0;border-top:none;border-radius:0 0 12px 12px">
        ...
        <p style="font-size:15px;color:#374151;line-height:1.7">Thank you for applying for the <strong>${role}</strong> position at LauncherDesk. We have received your application and our HR team will review it shortly.</p>
        <div style="background:#EFF6FF;border-left:4px solid #1D6FE0;border-radius:6px;padding:16px 18px;margin:20px 0">
          <p style="margin:0;font-size:14px;color:#1E40AF;font-weight:600">What happens next?</p>
          <ul style="margin:8px 0 0;padding-left:18px;color:#1D4ED8;font-size:14px;line-height:1.9">
            ...
            <li>Shortlisted candidates will be contacted for a telephonic round</li>
            <li>Interview process: Phone → In-person / Video</li>
          </ul>
        </div>
        <p style="font-size:14px;color:#64748B">Questions? Reach us at <a href="mailto:hr@launcherdesk.com" style="color:#1D6FE0;font-weight:600">hr@launcherdesk.com</a> or WhatsApp <a href="https://wa.me/918548854859" style="color:#1D6FE0;font-weight:600">+91 85488 54859</a></p>
        <hr style="border:none;border-top:1px solid #e2e8f0;margin:20px 0"/>
        <p style="font-size:12px;color:#94A3B8;text-align:center">LauncherDesk — Startups Made Easy | <a href="https://launcherdesk.in" style="color:#1D6FE0">launcherdesk.in</a></p>
      </div>
    </div>
...
module.exports = { sendEmail, contactAckEmail, contactNotifyEmail, quoteNotifyEmail, quoteAckEmail, applicationNotifyEmail, applicationAckEmail }